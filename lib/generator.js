...
exports.generate = function() {
    ...
    try {
        var documentationConfig = fse.readJSONFileSync(path.join(config.get('docs'), 'config.json'));
    } catch(err) {
    ...
    try {
        fse.copy(config.get('res_path'), documentedComponentsPath);
    } catch(err) {
